...
class WasteType(Base):
    ...
    waste_infos: Mapped[list["WasteInfo"]] = relationship("WasteInfo", back_populates="waste_type")
...
class WasteInfo(Base):
    ...
    waste_type_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("waste_types.id"), nullable=False)

    waste_type: Mapped["WasteType"] = relationship("WasteType", back_populates="waste_infos")
    images: Mapped[list["Image"]] = relationship("Image", back_populates="waste_info")
...
class Prediction(Base):
    ...
    image: Mapped["Image"] = relationship("Image", back_populates="prediction", uselist=False)
...
class Image(Base):
    ...
    waste_info_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("waste_infos.id"))
    ...
    waste_info: Mapped["WasteInfo | None"] = relationship("WasteInfo", back_populates="images")
    prediction: Mapped["Prediction | None"] = relationship("Prediction", back_populates="image")

...
def page_login():
    ...
    with col:
        ...
        with tab_in:
            ...
            with st.form("login"):
                email = st.text_input(
                    "Email", value=default_email, placeholder="vous@exemple.fr"
                )
                pwd = st.text_input(
                    "Mot de passe",
                    value=default_pwd,
        ...
        with tab_up:
            ...
            if not st.session_state.rgpd_accepted:
                ...
                <div class="rgpd-banner">
                    ...
                    Vos données (email, prénom, nom) sont collectées
                    uniquement pour l'accès à l'application.
                ...
                """, unsafe_allow_html=True)
                cb_txt  = (
                    "J'accepte la collecte et le traitement de mes "
                    "données personnelles."
                )
                if st.checkbox(cb_txt):
                ...
                if not all([fn, ln, em, p1, p2]):
                    ...
                    if err:
                        ...
                        st.success(
                            ...
                            " Connectez-vous dans l'onglet Connexion."
                        )
